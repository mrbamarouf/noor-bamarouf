...
export const copy = {
  en: {
    ...
    home: {
      ...
      selectedIntro: "Concept portfolio studies across identity, print, packaging, editorial, and social systems.",
      ...
      archiveTitle: "Concept portfolio",
    ...
    aboutPage: {
      ...
      body: "Nour Bamarouf’s portfolio is structured around identities, visual systems, print, packaging, and editorial experiences, with concise studio copy ready for her final biography.",
  ...
  ar: {
    ...
    home: {
      ...
      selectedIntro: "دراسات محفظة مفاهيمية عبر الهوية، المطبوعات، التغليف، التحرير، وأنظمة التواصل.",
    ...
    aboutPage: {
      ...
      body: "تتشكل محفظة نور بامعروف حول الهويات، الأنظمة البصرية، المطبوعات، التغليف، والتجارب التحريرية، مع نص استوديو موجز جاهز لسيرتها النهائية.",
