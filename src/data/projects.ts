...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: {
      en: "A corporate communication project built around the approved nine-page company profile and a curated selection from a 40-post social media system.",
      ar: "مشروع اتصال مؤسسي مبني حول الملف التعريفي المعتمد من تسع صفحات ومجموعة مختارة من نظام تواصل اجتماعي يضم 40 منشورًا.",
    },
    fullDescription: {
      en: "RED SEA Transport & Logistics is an official client project presented through the approved Company Profile PDF and six supplied social media posts. The case study keeps the profile pages intact and separates the curated social media work inside the brand's blue, red, and white logistics world.",
      ar: "البحر الأحمر للنقل والخدمات اللوجستية مشروع عميل رسمي يُعرض من خلال ملف الشركة التعريفي المعتمد وستة منشورات تواصل اجتماعي مقدمة. تحافظ دراسة الحالة على صفحات الملف كما هي وتفصل محتوى التواصل المختار ضمن عالم العلامة الأزرق والأحمر والأبيض.",
    },
    ...
    gallery: [
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 01 - Cover.", ar: "صفحة 01 من الملف التعريفي للبحر الأحمر - الغلاف." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 02 - About Us.", ar: "صفحة 02 من الملف التعريفي للبحر الأحمر - من نحن." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 03 - Our Services.", ar: "صفحة 03 من الملف التعريفي للبحر الأحمر - خدماتنا." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 04 - The Countries We Serve.", ar: "صفحة 04 من الملف التعريفي للبحر الأحمر - الدول التي نخدمها." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 05 - Truck Types.", ar: "صفحة 05 من الملف التعريفي للبحر الأحمر - أنواع الشاحنات." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 06 - Growth.", ar: "صفحة 06 من الملف التعريفي للبحر الأحمر - النمو." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 07 - Key Clients.", ar: "صفحة 07 من الملف التعريفي للبحر الأحمر - العملاء الرئيسيون." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 08 - Contact Us.", ar: "صفحة 08 من الملف التعريفي للبحر الأحمر - تواصل معنا." } },
      { variant: "redSeaTransport", scene: "materials", format: "png", folder: "projects", alt: { en: "RED SEA Company Profile page 09 - Thank You closing page.", ar: "صفحة 09 من الملف التعريفي للبحر الأحمر - صفحة الشكر والختام." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 01 - truck types Ton Dyna 3, Ton Lorry 7, and Ton Lorry 10.", ar: "منشور 01 للبحر الأحمر - أنواع الشاحنات دينا 3 طن، لوري 7 طن، ولوري 10 طن." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 02 - flatbed and curtain-side truck types.", ar: "منشور 02 للبحر الأحمر - أنواع شاحنات الفلاتبد والكيرتن سايد." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 03 - specialized shipping services.", ar: "منشور 03 للبحر الأحمر - خدمات شحن متخصصة." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 04 - customized transport solutions.", ar: "منشور 04 للبحر الأحمر - حلول نقل متكاملة للاحتياجات الخاصة." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 05 - transport-sector vision.", ar: "منشور 05 للبحر الأحمر - رؤية الشركة في قطاع النقل البري." } },
      { variant: "redSeaTransport", scene: "social", format: "jpg", folder: "projects", alt: { en: "RED SEA social media post 06 - partial shipments and border shipping.", ar: "منشور 06 للبحر الأحمر - الشحن الجزئي والشحنات عبر الحدود." } },
    ],
    caseStudy: {
      context: {
      ...
      applications: [
        ...
        { en: "Approved nine-page bilingual company profile", ar: "ملف تعريفي ثنائي اللغة معتمد من تسع صفحات" },
        { en: "Profile pages for cover, about, services, countries, fleet, growth, clients, contact, and closing", ar: "صفحات للغلاف، من نحن، الخدمات، الدول، الأسطول، النمو، العملاء، التواصل، والختام" },
        { en: "Curated selection of 6 posts from a 40-post social media system", ar: "مجموعة مختارة من 6 منشورات ضمن نظام تواصل يضم 40 منشورًا" },
        { en: "Transport, fleet, service, and logistics communication posts", ar: "منشورات اتصال للنقل، الأسطول، الخدمات، واللوجستيات" },
      ],
      outcome: {
        en: "A complete transport communication world: corporate, bilingual, operational, and extended from the company profile into a consistent social media system.",
        ar: "عالم اتصال متكامل لعلامة نقل: مؤسسي، ثنائي اللغة، تشغيلي، ويمتد من الملف التعريفي إلى نظام متسق لمحتوى التواصل الاجتماعي.",
      },
    },
