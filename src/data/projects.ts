...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: {
      en: "A curated social media design project for RED SEA, shaped through feed posts, stories, outdoor visuals, and selected campaign artwork.",
      ar: "مشروع تصميم وسائل تواصل اجتماعي منسق لـ RED SEA، يتشكل عبر منشورات، قصص، مرئيات إعلانية خارجية، وأعمال حملة مختارة.",
    },
    fullDescription: {
      en: "RED SEA is an official client project focused on social media design. The presentation brings together Instagram posts, story designs, highlight covers, National Day artwork, outdoor visuals, and logistics-focused supporting materials in a curated case study.",
      ar: "RED SEA مشروع عميل رسمي يركز على تصميم وسائل التواصل الاجتماعي. يجمع العرض منشورات Instagram، تصاميم القصص، أغلفة الهايلايت، عمل اليوم الوطني، المرئيات الخارجية، ومواد بصرية مرتبطة بعالم الخدمات اللوجستية ضمن دراسة حالة مختارة.",
    },
    services: ["socialMediaDesign", "graphicDesign"],
    credits: officialClientCredits,
    coverImage: {
      ...
      folder: "projects",
      alt: {
        en: "RED SEA curated National Day social artwork presented as the project cover.",
        ar: "عمل RED SEA لليوم الوطني معروض كغلاف للمشروع.",
      },
    },
    heroImage: {
      variant: "redSea",
      ...
      folder: "projects",
      alt: {
        en: "RED SEA campaign and social media artwork arranged as a wide hero presentation.",
        ar: "أعمال حملة ووسائل تواصل لـ RED SEA مرتبة كعرض رئيسي واسع.",
      },
    },
    gallery: [
      { variant: "redSea", scene: "materials", format: "webp", folder: "projects", alt: { en: "RED SEA supporting logistics communication visuals arranged for editorial review.", ar: "مرئيات تواصل مساندة لـ RED SEA مرتبطة بالخدمات اللوجستية ومعروضة للمراجعة التحريرية." } },
      ...
      { variant: "redSea", scene: "social", format: "webp", folder: "projects", alt: { en: "RED SEA final curated gallery board with feed, story, outdoor, and campaign materials.", ar: "لوحة معرض نهائية منسقة لـ RED SEA تضم المنشورات، القصص، المرئيات الخارجية، والحملة." } },
    ],
    caseStudy: {
      context: {
        en: "The source archive contains many social assets across posts, stories, outdoor visuals, and campaign moments. The portfolio presentation edits that archive down to the strongest finished visuals so the work reads as a coherent social media design project.",
        ar: "يجمع المشروع مواد متعددة لوسائل التواصل، بين المنشورات والقصص والمرئيات الخارجية ولحظات الحملة. يعرض البورتفوليو أقوى القطع المكتملة ليظهر العمل كمشروع تصميم وسائل تواصل متماسك.",
      },
      direction: {
      ...
      applications: [
        ...
        { en: "Highlight covers and quick identifiers", ar: "أغلفة الهايلايت ومعرّفات سريعة" },
      ...
      outcome: {
        en: "A focused social media presentation that turns a broad set of client visuals into a premium, readable case study with clear feed, story, outdoor, and campaign sections.",
        ar: "عرض مركز لتصميم وسائل التواصل يحوّل مجموعة واسعة من مرئيات العميل إلى دراسة حالة راقية وسهلة القراءة، بأقسام واضحة للمنشورات والقصص والمرئيات الخارجية ومواد الحملة.",
      },
    },
