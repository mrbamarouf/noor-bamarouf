...
const variantMarks: Record<ArtVariant, string> = {
  ...
  redBullMarvel: "Limited edition",
  impostor: "Awareness",
  wemoDelights: "Cookies",
  rahabaSpace: "Social posts",
  nirtoColdBrew: "Cold brew",
  zahyStore: "Logo mark",
  ansabHolding: "Holding mark",
  redSeaTransport: "Transport profile",
  studio: "Studio marks",
